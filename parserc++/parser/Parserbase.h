...
union STYPE__
{
 ...
 std::pair< std::vector< std::string > *, std::string *> * atomic_formula_term;
 ...
 std::pair<std::pair<std::vector< std::pair< std::pair< std::vector< std::string > *, std::string *> * ,int** >* > *,std::vector< std::pair< std::pair< std::vector< std::string > *, std::string *> * ,int** >* > *> *,float> * cond_eff_durative;
 int * specifier_time;
};
